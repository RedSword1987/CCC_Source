...
public class BasicRowProcessor implements RowProcessor {
    ...
    private static class CaseInsensitiveHashMap extends HashMap<String, Object> {
        ...
        public boolean containsKey(Object key) {
            Object realKey = lowerCaseMap.get(key.toString().toUpperCase(Locale.ENGLISH));
        ...
        public Object put(String key, Object value) {
             ...
             * super.put(key, value))
             */
            Object oldKey = lowerCaseMap.put(key.toUpperCase(Locale.ENGLISH), key);
        ...
        public Object remove(Object key) {
            Object realKey = lowerCaseMap.remove(key.toString().toUpperCase(Locale.ENGLISH));
