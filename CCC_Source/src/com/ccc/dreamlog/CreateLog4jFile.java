...
public class CreateLog4jFile {
    public static boolean createLog4jFile(File log4jFile, File logFilePath, List<String> logNames) {
        try {
            ...
            fileTxtNew.writeLine("log4j.appender.FILE.File=" + logFilePath.getAbsolutePath() + "/SendMagPlatForm.log");
            ...
            for (String str : logNames) {
                ...
                fileTxtNew.writeLine("log4j.appender." + tempS + "_.File=" + logFilePath.getAbsolutePath() + "/" + str + "/" + tempS + ".log");
